...
//     // If there's a selected name, find it or set custom
//     if (widget.selectedName.isNotEmpty) {
//       int index = avatars.indexWhere((a) => a.name == widget.selectedName);
//       if (index != -1) {
...
//             // style: AppsTextStyles.WorkSansRegular14.copyWith(
...
//                 label: const Text('Choose your own name'),
